...
export default async function Header() {
  ...
  return (
    <header className="sticky top-0 w-full z-50">
      {/* Modern gradient background with orange theme */}
      ...
      {/* Floating light effect with orange glow */}
        ...
        <div className="flex items-center space-x-3">
          <SignedIn>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent 
                align="end" 
                className="w-72 mt-2 bg-slate-950/95 backdrop-blur-2xl border border-orange-500/20 shadow-2xl shadow-orange-500/20 rounded-3xl p-3"
              >
                {/* Career Roadmap Section */}
                <DropdownMenuLabel className="px-2 py-1 text-xs font-medium text-orange-400 uppercase tracking-wider">
                  Career Roadmap
                </DropdownMenuLabel>
                ...
                <DropdownMenuItem asChild>
                  <Link 
                    href="/roadmap" 
                    className="flex items-center gap-3 px-4 py-3 text-gray-200 hover:text-white hover:bg-gradient-to-r hover:from-orange-500/10 hover:to-amber-500/10 rounded-2xl transition-all duration-300 group cursor-pointer"
                  >
                    <div className="p-2 bg-gradient-to-r from-orange-500/20 to-amber-500/20 hover:from-orange-500/30 hover:to-amber-500/30 rounded-xl group-hover:scale-110 transition-all duration-300">
                ...
                <DropdownMenuSeparator className="my-2 bg-orange-500/10" />

                {/* Tools Section */}
                <DropdownMenuLabel className="px-2 py-1 text-xs font-medium text-amber-400 uppercase tracking-wider">
                  Career Tools
                </DropdownMenuLabel>
                ...
                <DropdownMenuItem asChild>
                  <Link 
                    href="/resume" 
                    className="flex items-center gap-3 px-4 py-3 text-gray-200 hover:text-white hover:bg-orange-500/10 rounded-2xl transition-all duration-300 group cursor-pointer"
                  >
                ...
                <DropdownMenuItem asChild>
                  <Link
                    href="/cover-letter"
                    className="flex items-center gap-3 px-4 py-3 text-gray-200 hover:text-white hover:bg-amber-500/10 rounded-2xl transition-all duration-300 group cursor-pointer"
                  >
                    <div className="p-2 bg-amber-500/20 hover:bg-amber-500/30 rounded-xl group-hover:scale-110 transition-all duration-300">
                      <PenBox className="h-4 w-4 text-amber-400" />
                    </div>
                    <div>
                ...
                <DropdownMenuItem asChild>
                  <Link 
                    href="/resume-parser" 
                    className="flex items-center gap-3 px-4 py-3 text-gray-200 hover:text-white hover:bg-rose-500/10 rounded-2xl transition-all duration-300 group cursor-pointer"
                  >
                    <div className="p-2 bg-rose-500/20 hover:bg-rose-500/30 rounded-xl group-hover:scale-110 transition-all duration-300">
                      <SearchCheck className="h-4 w-4 text-rose-400" />
                    </div>
                    <div>
          ...
          <SignedOut>
            <SignInButton>
              <Button 
                variant="outline" 
                className="px-3 sm:px-4 lg:px-6 py-2 h-9 sm:h-10 lg:h-11 bg-orange-500/5 hover:bg-orange-500/10 border border-orange-500/20 hover:border-orange-400/40 text-gray-200 hover:text-orange-300 rounded-xl sm:rounded-2xl font-medium transition-all duration-500 text-sm sm:text-base backdrop-blur-sm hover:shadow-lg hover:shadow-orange-500/20"
              >
                Sign In
              </Button>
            </SignInButton>
          ...
          <SignedIn>
            <div className="relative">
              <UserButton
                appearance={{
                  elements: {
                    avatarBox: "w-9 h-9 sm:w-10 sm:h-10 lg:w-11 lg:h-11 ring-2 ring-orange-500/20 hover:ring-orange-400/50 transition-all duration-500 hover:scale-105",
                    userButtonPopoverCard: "bg-slate-950/95 backdrop-blur-2xl border border-orange-500/20 shadow-2xl shadow-orange-500/20 rounded-3xl",
                    userPreviewMainIdentifier: "font-semibold text-gray-100",
                    userPreviewSecondaryIdentifier: "text-gray-400",
                    userButtonPopoverActions: "bg-orange-500/5 rounded-2xl",
                    userButtonPopoverActionButton: "text-gray-200 hover:text-white hover:bg-orange-500/10 rounded-xl transition-all duration-300",
              ...
              <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full border-2 border-slate-900 shadow-lg shadow-orange-500/50">
                <div className="w-full h-full bg-gradient-to-r from-orange-400 to-amber-400 rounded-full animate-ping opacity-75"></div>
              </div>
            </div>
          </SignedIn>
        </div>
