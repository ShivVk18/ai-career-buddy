      ...
      <div className="relative">
        ...
        <Card className="backdrop-blur-xl bg-gradient-to-br from-[#1a1815]/80 to-[#252218]/60 border border-[#f59e0b]/10 relative z-10 rounded-3xl">
          <CardHeader className="text-center py-16">
            ...
            <CardTitle className="text-2xl text-white mb-2">No Cold Emails Yet</CardTitle>
            <CardDescription className="text-[#b0b0b0] text-lg">
              Create your first AI-generated cold email to get started
            </CardDescription>
            <div className="mt-8">
              <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="backdrop-blur-xl bg-gradient-to-br from-[#f59e0b]/10 to-[#fbbf24]/10 border border-[#f59e0b]/30 rounded-3xl p-6 shadow-xl shadow-[#f59e0b]/5 hover:shadow-[#f59e0b]/10 transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[#fbbf24] text-sm font-medium mb-1">Total Emails</p>
        ...
        {coldEmails.map((letter, index) => (
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <span className="text-xs text-gray-500 font-medium uppercase tracking-wider">Cold Email</span>
                </div>
              ...
              <div className="flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent className="backdrop-blur-xl bg-[#1a1815]/95 border-[#f59e0b]/20">
                    <AlertDialogHeader>
                      <AlertDialogTitle className="text-white text-xl">Delete Cold Email?</AlertDialogTitle>
                      <AlertDialogDescription className="text-[#b0b0b0]">
                        This action cannot be undone. This will permanently delete your cold email for{" "}
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#b0b0b0] text-sm line-clamp-2 leading-relaxed">{letter.jobDescription}</p>
