...
export default function ColdEmailList({ coldEmails }) {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      toast.error(error.message || "Failed to delete cold email")
    }
  }
      ...
      <div className="relative">
        <Card className="bg-divider/5 border-divider/30 rounded-sm">
          <CardHeader className="text-center py-20">
            ...
            <CardTitle className="text-2xl font-clash font-bold text-foreground uppercase tracking-tight mb-2">No Cold Emails Yet</CardTitle>
            <CardDescription className="text-muted-foreground text-lg font-light max-w-md mx-auto">
              Ready to land that interview? Create your first AI-generated cold email today.
            </CardDescription>
            <div className="mt-10">
              <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="border border-divider bg-divider/5 rounded-sm p-8 shadow-sm group hover:border-accent transition-editorial">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted-foreground text-[10px] font-bold tracking-widest uppercase mb-2">Total Emails</p>
              <p className="text-4xl font-clash font-bold text-foreground tracking-tight">{coldEmails.length}</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {coldEmails.map((letter) => (
          <div
            ...
            onClick={() => router.push(`/cold-email/${letter.id}`)}
          >
            ...
            <div className="flex items-start justify-between mb-8">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Cold Email</span>
                </div>
              ...
              <div className="flex space-x-3 opacity-0 group-hover:opacity-100 transition-editorial">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent className="bg-background border-divider rounded-sm">
                    <AlertDialogHeader>
                      <AlertDialogTitle className="font-clash font-bold uppercase tracking-tight">Delete Cold Email?</AlertDialogTitle>
                      <AlertDialogDescription className="text-muted-foreground font-light">
                        This action cannot be undone. This will permanently delete your email for{" "}
